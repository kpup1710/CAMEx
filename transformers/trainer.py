...
from .deepspeed_local import deepspeed_init, deepspeed_load_checkpoint, is_deepspeed_zero3_enabled
...
class Trainer:
    ...
    def _hp_search_setup(self, trial: Union["optuna.Trial", Dict[str, Any]]):
        ...
        if self.is_deepspeed_enabled:
            ...
            from transformers.deepspeed_local import HfTrainerDeepSpeedConfig
