...
try:
    ...
    _import_structure["models.mt5"].extend(
        ["MT5EncoderModel", "MT5ForConditionalGeneration", "T5ForSequenceClassification", "MT5Model", "MT5PreTrainedModel"]
    )
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.t5 import FlaxT5EncoderModel, FlaxT5ForConditionalGeneration, FlaxT5Model, FlaxT5PreTrainedModel,T5ForSequenceClassification
