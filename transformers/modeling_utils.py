...
from .deepspeed_local import deepspeed_config, is_deepspeed_zero3_enabled
...
def _load_state_dict_into_model(model_to_load, state_dict, start_prefix):
    ...
    if hasattr(model_to_load.config, 'use_moe') and model_to_load.config.use_moe in ['CAMEx', 'Conv1D_CAMEx']:
        load_CAMEx(model_to_load, state_dict)
...
def load_CAMEx(model, state_dict):
